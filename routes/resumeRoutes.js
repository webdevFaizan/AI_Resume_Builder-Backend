...
resumeRouter.post('/deleteResume', protect, deleteResume);
resumeRouter.post('/getResumebyId', protect, getResumeById);
resumeRouter.post('/getPublicResumebyId', getPublicResumeById);
