...
import { changePublicVisibilityForResume, createResume, createResumeAndPrefillData, deleteResume, getAllResumeByUserId, getPublicResumeById, getResumeById, updateResume } from "../controller/ResumeController.js";
...
//The following endpoint would be for the feature of uploading existing resume.
resumeRouter.post('/uploadResume', protect, createResumeAndPrefillData);


resumeRouter.post('/publicVisibilityToggle', protect, changePublicVisibilityForResume);
